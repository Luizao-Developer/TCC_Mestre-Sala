...
<meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="../barbearia_arquivos_css/esqueceuSenha.css">
...
<body>
    ...
    <div id="logo">
        ...
        <p><h5>Insira seu email para ser enviado um link, <p>para então redefinir sua senha e voltar a ter acesso a sua conta!</p></h5></p>
        <p>
        ...
        <hr> 
        <p>
            <a href="MScadastro_barbearia.php">Criar uma nova conta</a>
        </p>
        <hr>
        <p>
            <a href="MSlogin_barbearia.php">Retornar ao login</a>
        </p>
    </div>
...
<script>
  ...
  $("#link").click(function(){
      ...
      $.ajax({
        url: "../controladorBarbearia/geraLinkSenha.php",
        type : 'POST',
        data : 'email=' + email,
